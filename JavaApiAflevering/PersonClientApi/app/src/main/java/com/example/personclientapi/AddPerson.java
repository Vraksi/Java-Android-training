...
public class AddPerson extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTrue = findViewById(R.id.driversLicenseTrue);
        btnFalse = findViewById(R.id.driversLicenseFalse);
        ...
        if (intent.getBooleanExtra("bool", false) == true)
        {
            ...
            if (per.driversLicense)
            {
                btnTrue.setChecked(true);
                btnFalse.setChecked(false);
            }
            else
            {
            ...
            String eva = per.getGender();
            if ("Male".equals(eva))
            {
                gender.setSelection(0);
            }
            else if ("Female".equals(eva))
            {
                gender.setSelection(1);
            }
            else if ("Non-Binary".equals(eva))
            {
                gender.setSelection(2);
            }
            else if ("Pan-gender".equals(eva))
            {
